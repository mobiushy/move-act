...
class SDFeaturizer:
    def __init__(self, sd_id='CompVis/stable-diffusion-v1-4', null_prompt=''):
    ...
    def forward(self,
        ...
        for up_ft_index in up_ft_indices:
            ...
            unet_ft = unet_ft.mean(0, keepdim=True).squeeze(0) # 1,c,h,w
            unet_fts.append(resize(unet_ft))

        
        return torch.cat(unet_fts, dim=0)
